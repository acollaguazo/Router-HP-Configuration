...
#variables recibidas
$hostname = "R22_ESM";
$ip_mask_NextHop = "$ARGV[0]";

#variables enviadas como parametros
$comando = "system-view\nip route-static $ip_mask_NextHop\nquit\nsave\ny\n\ny";
...
@output =$t->cmd(String => 'screen-length disable',Prompt => '/[\]%#>]$/');
#print @output;
...
print "\n\nRUTA ESTATICA INSERTADA EXITOSAMENTE\n";
